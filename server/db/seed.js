export function seed(db) {
  ...
  const pharm2 = insertPharmacy.run(null, 'HealthPlus Pharmacy', 'pharmacy', 'Surulere, Lagos', 6.4980, 3.3610, '+2348012345002', 1, 4.6, 'Daily 8AM–9PM', 128)
  const pharm3 = insertPharmacy.run(null, 'CarePoint Pharmacy', 'pharmacy', 'Lagos Island', 6.4550, 3.3920, '+2348012345003', 1, 4.5, 'Mon–Sat 8AM–8PM', 89)
  const pharm4 = insertPharmacy.run(null, 'MedLine Pharmacy', 'pharmacy', 'Yaba, Lagos', 6.5095, 3.3711, '+2348012345004', 0, 4.2, 'Daily 7AM–10PM', 47)
  const hosp1  = insertPharmacy.run(hospital.lastInsertRowid, 'General Hospital Lagos', 'hospital', 'Lagos Island', 6.4541, 3.3947, '+2348012345005', 1, 4.7, '24 Hours', 312)
  const sup1   = insertPharmacy.run(supplier.lastInsertRowid, 'MediSupply Wholesalers', 'supplier', 'Ikeja, Lagos', 6.6018, 3.3515, '+2348012345006', 1, 4.9, 'Mon–Fri 8AM–5PM', 76)
  insertPharmacy.run(null, 'PharmaDist Ltd', 'supplier', 'Victoria Island, Lagos', 6.4281, 3.4219, '+2348012345007', 1, 4.7, 'Mon–Fri 8AM–6PM', 54)
  insertPharmacy.run(null, 'NovaMed Distributors', 'supplier', 'Yaba, Lagos', 6.5095, 3.3711, '+2348012345008', 1, 4.5, 'Mon–Fri 9AM–5PM', 38)
